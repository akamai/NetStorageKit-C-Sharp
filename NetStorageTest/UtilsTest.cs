...
namespace Akamai.Utils
{
    ...
    public class UtilsTest
    {
        ...
        public class Customer
        {
            ...
            [DataMember(Name = "SecretIdentity")]
            public string Alias { get; set; }
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestToQueryStringNull()
        {
            ExtensionMethods.ConvertToQueryString(null);
        }

        [TestMethod]
        public void TestToQueryString()
        {
            var a = new Customer() { Name = "Bruce", Company = "Wayne" };
            Assert.AreEqual(a.ConvertToQueryString(), "Name=Bruce&Company=Wayne");

            a = new Customer { Name = "Bruce Wayne" };
            Assert.AreEqual(a.ConvertToQueryString(), "Name=Bruce%20Wayne");

            a = new Customer() { Name = "Bruce", Alias = "Batman"};
            Assert.AreEqual(a.ConvertToQueryString(), "Name=Bruce&SecretIdentity=Batman");
        }
    }
}
